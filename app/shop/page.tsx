  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <section className="pt-32 md:pt-40 pb-12 md:pb-20 px-6 text-center relative overflow-hidden">
         <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] md:w-[500px] h-[300px] md:h-[500px] bg-[#d4af37] opacity-5 blur-[100px] md:blur-[150px] rounded-full pointer-events-none" />
         
         <motion.h1 
           initial={{ opacity: 0, y: 20 }}
           animate={{ opacity: 1, y: 0 }}
           className="text-3xl md:text-6xl font-serif text-white mb-4 md:mb-6 relative z-10"
         >
         ...
         <motion.p 
           ...
           className="text-gray-400 max-w-xl mx-auto text-sm md:text-lg relative z-10"
         >
      ...
      <section className="container mx-auto px-4 md:px-6 pb-32">
        {loading ? (
          ...
          // CHANGED: grid-cols-2 on mobile (default), gap-3 for tighter mobile fit
